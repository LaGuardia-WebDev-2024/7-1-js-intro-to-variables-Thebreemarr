...
void draw(){
  ...
  ellipse(150, 70, 60, longEar);  // left ear
  ellipse(240, 70, 60, longEar);  // right ear
  ...
  //white
  fill(255,255,255)
  ellipse(177,133,10,10)
  ellipse(240,129,10,10)
  ellipse(160,141,30,30)
  ellipse(222,138,30,30)
